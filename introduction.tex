...
A complex activity typically comprises several sub-events.
...
and optimum contribution ratio of static and motion information may depend on the richness of the motion information.
...
In this work, we focus on video activity recognition using both static and motion information. We address three problem areas: crafting independent static and motion features, optimal fusion of the crafted features, and
...
vary depending on the richness of the motion information, and affects the final accuracy significantly.
...
accuracy. We carry out our experiments on the two popular action datasets, UCF-11 \cite{liu2009recognizing}
...
%Also, we show that the optimum contribution may vary depending on the dataset, and affects the final accuracy significantly.
 ...
 this optimum ratio depends on the dataset. Hence, it is beneficial to exploit this optimum ratio for a better accuracy.
