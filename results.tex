...
\pgfplotstableread[row sep=\\,col sep=&]{
  ...
  \begin{figure}  
   \begin{tikzpicture}
    ...
    \end{axis}
\end{tikzpicture}
\caption{Accuracy comparison between Random Forest Classiffier and LSTM for UCF-11 dataset. Motion:static ratio of 20:80 is used. Accuracy is significantly higher
...
\pgfplotstableread[row sep=\\,col sep=&]{
  ...
  \begin{figure}  
   \begin{tikzpicture}
    ...
    \end{axis}
\end{tikzpicture}
\caption{mAP comparison for Random Forest Classiffier and LSTM for Hollywood2 dataset. Motion:static ratio of 20:80 is used. mAP is significantly higher
when the temporal dynamics of sub events are captured.}
