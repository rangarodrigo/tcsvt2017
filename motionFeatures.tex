This section discusses the detailed methodology of creating motion features, particulary, ``Motion tubes'', ``HOOF'', and ``BoW'' blocks as illustrated in Fig. \ref{fi:overall}. 
